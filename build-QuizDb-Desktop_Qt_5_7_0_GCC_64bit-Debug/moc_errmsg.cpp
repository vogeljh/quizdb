...
#include "../../../../quizdb/QuizDb/errmsg.h"
...
struct qt_meta_stringdata_errmsg_t {
    QByteArrayData data[1];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_errmsg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_errmsg_t qt_meta_stringdata_errmsg = {
    {
QT_MOC_LITERAL(0, 0, 6) // "errmsg"
...
const QMetaObject errmsg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_errmsg.data,
      qt_meta_data_errmsg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *errmsg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_errmsg.stringdata0))
