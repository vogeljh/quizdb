...
struct qt_meta_stringdata_codes_t {
    QByteArrayData data[4];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_codes_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_codes_t qt_meta_stringdata_codes = {
    {
QT_MOC_LITERAL(0, 0, 5), // "codes"
QT_MOC_LITERAL(1, 6, 10), // "OK_clicked"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 14) // "Cancel_clicked"

    },
    "codes\0OK_clicked\0\0Cancel_clicked"
};
...
const QMetaObject codes::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_codes.data,
      qt_meta_data_codes,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *codes::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_codes.stringdata0))
