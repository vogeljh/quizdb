...
struct qt_meta_stringdata_quizload_t {
    QByteArrayData data[4];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_quizload_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_quizload_t qt_meta_stringdata_quizload = {
    {
QT_MOC_LITERAL(0, 0, 8), // "quizload"
QT_MOC_LITERAL(1, 9, 10), // "OK_clicked"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14) // "cancel_clicked"

    },
    "quizload\0OK_clicked\0\0cancel_clicked"
};
...
const QMetaObject quizload::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_quizload.data,
      qt_meta_data_quizload,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *quizload::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_quizload.stringdata0))
