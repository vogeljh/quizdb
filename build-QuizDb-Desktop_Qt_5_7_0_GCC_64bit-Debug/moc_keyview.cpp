...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_keyView_t, stringdata0) + ofs \
...
const QMetaObject keyView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_keyView.data,
...
void *keyView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_keyView.stringdata0))
