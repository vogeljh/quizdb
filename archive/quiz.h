...
protected:
	...
	int qzdatarows;
	int qzformatrows;
	qzdata qzData[MAXQUIZZES][MAXSECTIONS][MAXQUESTIONS];
	...
	void MakeQuiz( int );
	void ReviewQuiz( int );
	int GetQnum( const int, const int, const int, const int, const int );
	int ChooseQuest( QSqlQueryModel *, const int, const int, const int, const int, const int, const int );
